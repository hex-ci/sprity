...
Handlebars.registerHelper('px', function (value) {
  var options = arguments[arguments.length - 1]
  delete arguments[arguments.length - 1];

  var width = arguments[1] || 75;

  return Math.round(value / width * 1000000) / 1000000;
});

Handlebars.registerHelper('offset', function (y, height, totalHeight) {
  var options = arguments[arguments.length - 1]
  delete arguments[arguments.length - 1];

  var width = arguments[1] || 75;

  return -Math.round(y / (height - totalHeight) * 100 * 1000000) / 1000000;
});
